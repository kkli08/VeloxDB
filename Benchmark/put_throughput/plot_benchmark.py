...
# Read the CSV files for Linux and macOS
linux_data = pd.read_csv("linux_put_throughput.csv")
macos_data = pd.read_csv("macos_put_throughput.csv")
...
# Plot macOS data with solid lines instead of dashed lines
...
plt.title('Put Throughput for Different Memtable Sizes (Linux vs. macOS)')
